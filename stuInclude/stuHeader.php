    ...
    <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
        <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            <a href="/" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
                <span class="fs-5 d-none d-sm-inline"><?= $user_name; ?></span>
            </a>
            <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                <li class="nav-item">
                    <a href="studentProfile.php" class="nav-link align-middle px-0">
                        <i class="fa-solid fa-user" style="color: #2270f7;"></i> <span
                            class="ms-1 d-none d-sm-inline">Profile</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="myCourses.php" class="nav-link align-middle px-0">
                        <i class="fa-solid fa-book" style="color: #0a5ae6;"></i> <span
                            class="ms-1 d-none d-sm-inline">My Courses</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="studentFeedbacks.php" class="nav-link align-middle px-0">
                        <i class="fa-solid fa-comment" style="color: #1860dc;"></i> <span
                            class="ms-1 d-none d-sm-inline">Feedback</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="studentChangePass.php" class="nav-link align-middle px-0">
                        <i class="fa-solid fa-lock" style="color: #185ed8;"></i> <span
                            class="ms-1 d-none d-sm-inline">Change Password</span>
                    </a>
                </li>
            </ul>
            <hr>
